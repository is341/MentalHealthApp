...
import com.mental_health.views.ViewBuilder;

import java.util.ArrayList;

import com.mental_health.models.ChatMessage;
import com.mental_health.viewholders.MessageViewHolder;
import com.mental_health.views.ViewBuilder;
import com.mental_health.views.ViewBuilderInterface;
...
public class ChatViewListAdapter extends BaseAdapter {
    ...
    public ChatViewListAdapter(Context context, ViewBuilder viewBuilder, int backgroundRcv, int backgroundSend, int bubbleBackgroundRcv, int bubbleBackgroundSend, float bubbleElevation) {
