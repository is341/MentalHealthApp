...
public class ShowQuizActivity extends AppCompatActivity {
    ...
    String Tag = "Tstng_ShowQuizActivity";
    ProgressBar pBar;
    int q1 = -1;
    int q2 = -1;
    int q3 = -1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new BackGroundTasks(ShowQuizActivity.this, Constants.Patient + "?patient_id=" + userId).execute();
    ...
    private void IfMethods(JSONObject object) {
        ...
        try {
            ...
            if (object.getString("Response") != null) {
                ...
                pBar.setVisibility(View.INVISIBLE);
                Toast.makeText(ShowQuizActivity.this, "Something went wrong", Toast.LENGTH_LONG).show();
    ...
    private void extracted(String question_id, String answer) {
